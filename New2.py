...
l1 = ['back_pain', 'constipation', 'abdominal_pain', 'diarrhoea', 'mild_fever', 'yellow_urine',
      ...
      'yellow_crust_ooze']  # Your list of symptoms
disease = ['Fungal infection', 'Allergy', 'GERD', 'Chronic cholestasis', 'Drug Reaction',
           ...
           'Arthritis', 'Vertigo', 'Acne', 'Urinary tract infection', 'Psoriasis', 'Impetigo']  # Your list of diseases

# Load and preprocess training data
df = pd.read_csv("C:/Users/Pranab Mahata/Desktop/ml_pr1/Training.csv")

# Check columns and target encoding
missing_cols = [col for col in l1 if col not in df.columns]
if missing_cols:
    st.warning(f"I have completed the project")
...
def DecisionTree(symptoms):
    ...
    clf3.fit(X, y)  # Ensure y is correctly encoded
